...
import { deleteUserAddressAsync, selectUserInfo, updateUserAsync } from "../userSlice";
...
export default function UserProfile() {
  ...
  const handleEdit = (addressUpdate, index) => {
    console.log("addressUpdate", addressUpdate, index);
  ...
  const handleRemove = (e, index) => {
    ...
    console.log(newUser);
    dispatch(deleteUserAddressAsync({index}));
  };
  ...
  const handleAdd = (address) => {
    ...
    // };
    dispatch(updateUserAsync(address));
    ...
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {userInfo.role === "user" && (
          ...
          <p className="mt-0.5 text-base mb-3 text-gray-500 font-medium">Your Addresses :</p>
