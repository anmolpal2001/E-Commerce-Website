...
export default function ProductDetail() {
  ...
  console.log("Items on product detail ", items);
  ...
  const handleCart = (e) => {
    ...
    if (!items || items.length === 0) {
      // If the items array is empty, proceed to add the product to the cart
      const newItem = {
        product: product.id,
        quantity: 1,
      };
      ...
      dispatch(addToCartAsync({ item: newItem, toast, token: user.token }));
    } else {
