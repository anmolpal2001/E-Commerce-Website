...
export default function AdminProductList() {
  ...
  const admin = user && user.role === 'admin' ? true : false;
  ...
  const handleFilter = (e, section, option) => {
    ...
    const filterValues = newFilter[section.id] || new Set();
    ...
    newFilter[section.id] = filterValues;
    setFilter(newFilter);
  };
      ...
      <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <div key={product.id} className='border-2 border-gray-200'>
              
              <Link to={`/admin/product-detail/${product.id}`} >
                <div className="group relative p-2 border border-gray-200">
                  ...
                  {product.deleted && (
                    <div>
                      <p className="text-sm text-red-600 text-center">Product Deleted</p>
                    </div>
                  )}
                  {product.stock<=0 && (
                  <div>
              ...
              <div className="my-2 flex justify-center items-end w-full">
                <Link
                  to={`/admin/product-form/edit/${product.id}`}
                  className="rounded-md bg-indigo-600 px-3 w-2/3 text-center py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
