...
export default function ResetPassword() {
  ...
  return (
    <>
      {(id && token) ? <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 className="mt-5 text-center text-2xl font-medium leading-9 tracking-tight text-gray-700">
          Reset Password
          </h2>
        </div>
